...
# Main application
def main():
    st.title("Diagnosa Mental Health")
    ...
    if st.session_state.page == "home":
        st.subheader("Diagnosa Mental Health merupakan keadaan di mana seseorang mampu mengelola stres sehari-hari, berkontribusi pada komunitasnya, bekerja secara produktif, dan menyadari potensi dirinya.")
        if st.button("Login"):
            st.session_state.page = "login"
        ...
        st.subheader("Selesaikan pertanyaan berikut dan dapatkan hasil diagnosa yang sesuai dengan keluhan Anda")
        questions = [
            "Apakah Anda merasa sulit untuk fokus pada tugas sehari-hari?",
            "Apakah Anda mengalami perubahan nafsu makan yang signifikan?",
            "Apakah Anda sering merasa tidak memiliki energi?",
            "Apakah Anda merasa putus asa atau tidak berdaya?",
            "Apakah Anda mengalami perubahan pola tidur?",
            "Apakah Anda sering merasa marah atau frustrasi?",
            ...
            "Apakah Anda mengalami sakit fisik tanpa penyebab medis yang jelas?",
            "Apakah Anda sering berpikir tentang kematian atau bunuh diri?"
        ]
        answers = []
